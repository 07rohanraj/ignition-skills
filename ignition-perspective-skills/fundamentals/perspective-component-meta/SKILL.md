---
name: perspective-component-meta
description: Perspective component meta properties (name, visible, tooltip, hotkey, styleClass, meta). Use when setting component meta properties or locating the component tree in view.json.
---
