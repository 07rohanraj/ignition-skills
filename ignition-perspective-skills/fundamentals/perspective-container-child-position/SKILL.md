---
name: perspective-container-child-position
description: Perspective container child item position properties (x, y, width, height, margin, coordinate container). Use when positioning children inside a container.
---
