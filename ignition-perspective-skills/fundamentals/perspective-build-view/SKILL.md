---
name: perspective-build-view
description: Building a new Perspective view from scratch (view.json, root container, params, propConfig). Use when creating a new view or starting a Perspective view build.
---
