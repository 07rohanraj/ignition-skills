...
description: Perspective Query Binding that executes a Named Query. Use when binding a component property to database results via queryPath, parameters, polling, and returnFormat.
---
