...
description: Perspective Expression Binding. Use when binding a property to a computed expression string using functions, operators, and property references.
---
