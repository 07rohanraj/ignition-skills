---
name: perspective-dropdown
description: Perspective Dropdown (ia.input.dropdown) for selecting one option from a list. Use when binding options, value, and placeholder.
---
