...
description: Use this skill when the Gateway APIs requires to call, needs to find an API endpoint, or wants to understand how to interact with the Ignition Gateway via REST. Contains the full OpenAPI specification for searching at \openapi.json file.
---
